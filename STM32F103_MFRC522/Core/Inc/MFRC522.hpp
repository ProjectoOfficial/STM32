...
public:
	...
	static constexpr uint16_t UNUSED_PIN = UINT16_MAX;
	static constexpr GPIO_TypeDef *UNUSED_PORT = nullptr;

	enum PinModes : uint8_t {
		INPUT		= 0x01,
		OUTPUT 		= 0x02,
	};
	...
	// constructors
	/////////////////////////////////////////////////////////////////////////////////////
	MFRC522(SPI_HandleTypeDef *spi);
	MFRC522(SPI_HandleTypeDef *spi, GPIO_TypeDef* ResetPort, uint16_t ResetPin);
	MFRC522(SPI_HandleTypeDef *spi, GPIO_TypeDef* CSPort, uint16_t CSPin, GPIO_TypeDef* ResetPort, uint16_t ResetPin);
	...
	/////////////////////////////////////////////////////////////////////////////////////
	void pinMode(GPIO_TypeDef *GPIO_Port, uint16_t GPIO_Pin, PinModes mode);
	void PCD_Init();
	void PCD_Init(SPI_HandleTypeDef *spi, GPIO_TypeDef* ResetPort, uint16_t ResetPin);
	void PCD_Init(SPI_HandleTypeDef *spi, GPIO_TypeDef* CSPort, uint16_t CSPin, GPIO_TypeDef* ResetPort, uint16_t ResetPin);
	void PCD_Reset();
	void PCD_AntennaOn();
	void PCD_AntennaOff();
